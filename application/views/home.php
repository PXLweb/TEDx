...
<!--        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js" type="text/javascript" ></script>-->
        <script src="<?php echo base_url('assets/docs/dist/js/bootstrap.min.js') ?>"></script>"
        <script src="<?php echo base_url('assets/docs/assets/js/vendor/holder.min.js') ?>"></script>
